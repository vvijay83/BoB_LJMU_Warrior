...
2% of total retail payments

15% of total retail payments

PPS(>5 lakhs,saving A/C

\>10 lakhs, other)

20% of total cheques issued

80% of total cheques issued
...
● Cheque clearing cycle has been a

manual process to till date resulting

in delayed transactions, Frauds and

customer dissatisfactions.

● Manual cheque clearing cycle

requires human resources and

cost more

● Current proposal augments the

highlighted portion of the check
...
**Solution architecture- Azure stack**
